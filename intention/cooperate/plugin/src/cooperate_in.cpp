...
void CooperateIn::Initial::OnStartWithOptions(Context &context, const CooperateEvent &event)
{
    ...
    FI_HILOGE("szy_CooperateIn__OnStartWithOptions____displayX :%{public}d", notice.displayX);
    FI_HILOGE("szy_CooperateIn__OnStartWithOptions____displayY :%{public}d", notice.displayY);
    FI_HILOGE("szy_CooperateIn__OnStartWithOptions____displayId :%{public}d", notice.displayId);
    if (context.IsLocal(startEvent.remoteNetworkId)) {
